% M-file for outputing the pitch attitude quickness
close all
clear all
clc

% Loading quickness data
load pitchquickness5deg
load pitchquickness10deg
load pitchquickness15deg
load pitchquickness20deg
load pitchquickness25deg
load pitchquickness30deg
