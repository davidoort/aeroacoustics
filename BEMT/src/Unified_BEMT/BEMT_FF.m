function [Thrust, Torque, Power, CT, CP, net_torque_coeff] = BEMT_FF(rotorsystem,atm,epsilon,plots,verbose)
%{
AXIAL & FORWARD Flight Leishman method!
...
while err>epsilon
    ...
    %lambda = getLambda_Leish(flowfield(1).lambda_P, dCTu,F_old, r, dr,dpsi);
