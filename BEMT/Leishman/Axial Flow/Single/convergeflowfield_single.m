function [Fcf_u, lambda_u] = convergeflowfield(flowfield, r, epsilon, rotor)
%{
convergeflowfield_ SINGLE! - This function solves for the Prandtl tip loss function
along the span of the blade on the upper rotor as well as the
inflow ratio lambda on the upper rotor. It is called
