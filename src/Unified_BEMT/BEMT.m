...
difference_method = false; %if set to true this will show the difference in predictions between the "leishman" and "airfoil" methods

tic
%% Init 
if debug
    % adjust resolution/ discretization detail (element number)
    res_r = 10;
    res_psi = 20;
